...
<div id="single-container">
    ...
    <div id="single-bot">
        <div id="single-bot-title">THÔNG TIN NGƯỜI ĐĂNG</div>
    ...
    <!-- phần hiển thị comment trên trang single -->
    <div id="single-cmt">
    <?php comments_template(); ?>
    </div> <!-- đóng phần div cmt --> 
...
while ($getposts1->have_posts()) :
    ...
    <img class="single-right-last-thum-crop" src="<?php echo catch_that_image_singlepost(); ?>" alt="<?php the_title(); ?>" />
    <!-- <img src="<?php bloginfo('template_directory'); ?>/images/default-image-120x120.png" alt="<?php the_title(); ?>" /> -->
    <?php };
    echo '</div>';
